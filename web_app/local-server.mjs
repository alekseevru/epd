...
async function loadDocumentStatistics(){
  const cacheKey="etrn-title2-title3-from-2026-09-v1";const cached=statisticsCache.get(cacheKey);if(cached?.expiresAt>Date.now())return cached.value;
