...
class AddressRegressions(unittest.TestCase):
    ...
    def test_empty_etrn_uses_container_stock_point_and_inn(self):
        ...
        self.assertEqual(consignee.get("КПП"), "772501001")
        self.assertEqual(consignee.get("НаимОрг"), 'ООО "КОНТВЭЛЛ"')
        self.assertEqual(root.findtext(".//СвГП//Контакт/Тлф"), "+78126039299")
